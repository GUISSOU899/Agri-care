...
class Forecast(Base):
    ...
    temperature_c = Column(Float, nullable=True) # celsius (kept for compat, alias to tmean)
    ...
    source = Column(String(30), nullable=False, server_default='api') # api, estimation
